...
- The following table lists the operators supported by the C# language −
  ...
  | | _= | Multiply AND assignment operator, It multiplies right operand with the left operand and assign the result to left operand |
...
### 2.20 C# Exception Handling

- When a program encounters a situation that it cannot handle, it throws an exception. An exception is a runtime error that can occur when there is a problem in code. Exception handling enables a program to deal with runtime errors and continue its normal flow of operations.
- The following example demonstrates how to use exception handling in a program −
...
#### 2.20.1. C# Exception Types

- C# provides a structured solution to the exception handling in the form of try and catch blocks. If an exception occurs in the protected code, the exception is thrown to the first catch block in the call stack. If the exception matches the type specified in the catch block, it will be caught there.
- The following table lists some of the exception types −
  ...
  | System.IndexOutOfRangeException | The exception that is thrown when an attempt is made to access an element of an array or collection with an index that is outside its bounds. |
  ...
  | System.StackOverflowException | The exception that is thrown when the execution stack overflows because it contains too many nested method calls. |

#### 2.20.2. C# Exception Properties

- The following table lists some of the properties of the exception object −
  | Property | Description |
  | --- | --- |
...
#### 2.20.3. C# Exception Handling Keywords

- The following table lists some of the keywords that are used to handle exceptions in C# −
  | Keyword | Description |
  | --- | --- |
  | try | The try block contains the guarded code that may cause the exception. The block is executed until an exception is thrown or it is completed successfully. |
  | catch | The catch block is used to handle the exception. It must be preceded by the try block which means that we can't use a catch block alone. |
  | finally | The finally block is used to execute a given set of statements, whether an exception is thrown or not thrown. For example, if you open a file, it must be closed whether an exception is raised or not. |
  | throw | The throw statement allows you to create a custom error. |

#### 2.20.4 C# throw Keyword

- The throw keyword is used to explicitly throw an exception. The throw keyword is mainly used to throw custom exceptions. It is followed by an exception instance. The following example demonstrates how to use throw keyword in a program −
...
#### 2.20.5. C# when Keyword in catch Block
- The when keyword is used to specify a condition. If the condition specified in the when clause is true, the handler is executed. The following example demonstrates how to use when keyword in a program −
...
namespace CalculatorApplication {
    class DivNumbers {
        ...
        static void Main(string[] args)
        {
            ...
            catch (DivideByZeroException e) when (e.Message == "Attempted to divide by zero.")
            {
                Console.WriteLine("Exception caught: {0}", e);
            }
            finally
...
#### 2.20.6. C# Multiple catch Blocks
- A try block can be followed by multiple catch blocks. The first catch block that handles the specific exception is executed. The following example demonstrates how to use multiple catch blocks in a program −
...
### 2.21 C# using Keyword

- The using keyword is used for including the namespaces in the program. The using statement obtains one or more resources, executes a statement, and then disposes of the resource.

### 2.22 C# File I/O

- C# provides various classes to perform various operations on files. In this chapter, you will learn how to read from and write into files by using classes like TextWriter, TextReader, FileStream, StreamReader, StreamWriter, and so on.
- The following example demonstrates how to use file I/O in a program −
...
namespace CalculatorApplication {
    class Program {
        static void Main(string[] args)
        {
            ...
            using (System.IO.TextWriter file = new System.IO.StreamWriter(@"D:\test.txt"))
            {
...
- You can access the attributes of an object by using the dot operator (.). The dot operator is also used to access members of a namespace.
- The following example demonstrates how to access attributes of an object −

```csharp
Object1.name = "Zara";
Object1.salary = 50000;
```

#### 4.1.6. Accessing Methods

- You can access the methods of an object by using the dot operator (.). The following example demonstrates how to access methods of an object −
...
- An object is a real-world entity having attributes (data type) and behaviors (functionality). For example, a chair, pen, table, keyboard, bike, etc. are all objects.
...
- The state of an object is represented by its attributes. An attribute is a type of variable that is declared inside a class. Attributes sometimes are called fields, member variables, or instance variables.
- A class can have many attributes that define its state. The value of an object's attributes defines the state of an object.

#### 4.2.2. C# Auto Properties

- Properties are members that provide a flexible mechanism to read, write, or compute the values of private fields. Properties can be used as if they are public data members, but they are actually special methods called accessors. This enables data to be accessed easily and still helps promote the safety and flexibility of methods.
- The following example demonstrates how to use auto properties in a program −
...
##### 4.2.2.1. C# init Accessor

- The init accessor is similar to the set accessor, except that it can be invoked only when the object is initialized during object construction. The following example demonstrates how to use init accessor in a program −
...
#### 4.2.3. C# Constructors

- A constructor is a special method of a class or structure in object-oriented programming that initializes an object of that type. A constructor is an instance method that usually has the same name as the class, and can be used to set the values of the members of an object, either to default or to user-defined values.
- The following example demonstrates how to use constructors in a program −
...
##### 4.2.3.1. C# Parameterized Constructors

- A constructor that accepts arguments is known as a parameterized constructor. The parameterized constructor is used to provide different values to distinct objects. However, you can provide the same values also.
- The following example demonstrates how to use parameterized constructors in a program −
...
namespace CalculatorApplication {
    class NumberManipulator {
        private int val;
        public string MyString {get; set;}
        public NumberManipulator(int val, string str)
        {
            this.val = val;
            MyString = str;
            Console.WriteLine("Constructor is called");
...
##### 4.2.3.2. C# Constructors Overload
...
- The following example demonstrates how to use constructor overloading in a program −
...
namespace CalculatorApplication {
    class NumberManipulator {
        ...
        {
            val = 100;
            MyString = "Constructor with no parameters";
        }
        public NumberManipulator(int val, string str)
        {
            this.val = val;
...
#### 4.2.4. C# Static Constructors

- Static constructors are used to initialize any static data, or to perform a particular action that needs to be performed once only. It is called automatically before the first instance is created or any static members are referenced.
- The following example demonstrates how to use static constructors in a program −
...
#### 4.2.5. C# Copy Constructors

- A copy constructor is a special constructor that initializes a new object from an existing object. In C#, a copy constructor is a parameterized constructor and we pass an object of the same class as a parameter.
- The following example demonstrates how to use copy constructors in a program −
...
namespace CalculatorApplication {
    class NumberManipulator {
        private int val;
        public string MyString {get; set;}
        public NumberManipulator(NumberManipulator n)
        {
            val = n.val;
            MyString = n.MyString;
...
- The following example demonstrates how to use destructor finalizers in a program −
